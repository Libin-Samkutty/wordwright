...
| ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [ENABLE1](https://github.com/dolph/dictionary/blob/master/enable1.txt) (Enhanced North American Benchmark Lexicon, Alan Beale) | The full guess list for each length          | **Public domain**, explicitly released by the author                                                  |
